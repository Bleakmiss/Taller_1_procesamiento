...
#El codigo fue diseñado para mostrar las propiedades de una imagen, una version de la imagen a blanco y negro y una version de la imagen con un H especifico
