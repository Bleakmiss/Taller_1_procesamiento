# Importacion de librerias utilizadas en el codigo
import cv2
import os
import numpy as np
...
class basicColor:
    ...
    def displayProperties(self):
        ...
        # Impresion de las caracteristicas de la imagen
        print("El numero de pixeles de las imagenes es: ",(pixeles)/1000000,"MP y el numero de canales de la imagen es:",canales[2])
